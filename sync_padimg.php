...
$sql = 'SELECT MONSTER_NO, MONSTER_NO_US FROM monsterList';
...
foreach($res as $r){
	download_image($miru_portrait_url, $portrait_url, $r['MONSTER_NO'], 'Portrait');
	download_image($miru_full_url, $fullimg_url, $r['MONSTER_NO'], 'Full Img');
